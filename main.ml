...
let select_episode () = 
  ...
  let rec select_battle_r () = 
    ...
    | Some 1 -> start_episode "Ep1dialogue.json" 6
    | Some 2 -> begin
        print_endline "\nSee you next time!";
        exit 0
      end
